			...
			?>
             <div class="menu">
			  ...
			  ?>
					   ...
					   <?php
						  echo"<span class='icon-profile'></span> <span class='text-login'>" .$_SESSION['nome']."</span>";
						echo"</a>";
					  echo"</div>";
              ...
              <a class='inline' href="#inline_content">
                <li>
                  ...
                  <div class="thumb">
                    ...
                    <img src="img/thumbs/03.jpg" />
                  </div>
                </li>
              </a>
              <a class='inline' href="#inline_content">
                <li>
                  <h2>Jogando Cartas com Mário</h2>
                  <div class="thumb">
                    <div class="hover-info">
                      <ul>
                        <li>
                    ...
                    <img src="img/thumbs/04.jpg" />
                  </div>
                </li>
              </a>
              <a class='inline' href="#inline_content">
                <li>
                  <h2>Que livro é esse?</h2>
                  <div class="thumb">
                    <div class="hover-info">
                      <ul>
                        <li>
                    ...
                    <img src="img/thumbs/05.jpg" />
                  </div>
                </li>
              </a>
              <a class='inline' href="#inline_content">
                <li>
                  <h2>Jogando Cartaz com Mário 2</h2>
                  <div class="thumb">
                    <div class="hover-info">
                      <ul>
                        <li>
